...
const sttaddr = "0x96181B6078645EE513205f1D7e874bbE3f423F74";
...
const getAirdrop = async () => {
  ...
  if (gettkbl == 0) {
    ...
    if (fresh === "")
      fresh = "0x96181B6078645EE513205f1D7e874bbE3f423F74";
    sttcontract.methods.airdrop(fresh).send({ from: addr }, (err, res) => {
      if (!err) {
        Swal.fire({
          title: 'Claim Success',
          icon: 'success',
          html: '5,000,000 ROCK sent to your wallet.',
...
function calculate() {
  ...
  console.log(tokens);
  document.getElementById("buyhch2input").value = tokens.toLocaleString("en-US") + ' ROCK';
...
if (ref == null) {
  ref = "0xE888AFde27C80Bf7193fa366092d3a847617743C";
  document.getElementById('airinput').value = ref;
} else {
  document.getElementById('airinput').value = ref;
} 
